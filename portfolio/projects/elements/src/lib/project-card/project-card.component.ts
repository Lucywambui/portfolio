...
export class ProjectCardComponent {
  ...
  projects: project[]= [
    ...
    {projectType:"SOFTWARE DEVELOPMENT",projectUrl:"assets/Dalila.png", projectName:"Dalila", projectDesc: "This is an e-commerce body care and skincare shop. I am currently building it using angular technologies", projectLink:"https://www.figma.com/proto/CRKZScMCHBZH3WZXBVyW13/e-commerce-web-project?page-id=0%3A1&type=design&node-id=11-154&viewport=-2122%2C391%2C0.34&t=jS3Nwrd1QuXfHuHd-1&scaling=scale-down&starting-point-node-id=11%3A154&mode=design", projectLink2:'https://dalila-lucywambui.vercel.app/' },
